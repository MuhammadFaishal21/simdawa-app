                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="<?= base_url('home') ?>" class="breadcrumb-link">Dashboard</a>
                                </li>
                                <li class="breadcrumb-item">
                                    <a href="<?= base_url('pendaftaran') ?>" class="breadcrumb-link">Pendaftaran Akun</a>
                                </li>
                        ...
                        <table class="table table-bordered" id="mytabel">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($pendaftaran as $a) : ?>
                                    <?php $lokasi = base_url('upload/bukti_daftar/' . $a->bukti_daftar); ?>
                                    <tr>
                                        <td><?= $no++ ?></td>
                                        ...
                                        <?php if ($a->keterangan == 'Belum Diverifikasi') : ?>
                                            <td>
                                                ...
                                                <a href="<?= base_url('pendaftaran/verifikasi/batal/' . $a->id) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Ingin batalkan akun ini?')">
